...
VEGETARIAN = {
              ...
              'masa', 'red chili', 'red onions', 'jalape￱o chili', 'grated nutmeg', 'feta cheese', 'hazelnuts',
...
PALEO = {
         'cinnamon', 'chiles de ￡rbol', 'chives', 'limes', 'allspice', 'zucchini', 'seranno chili', 'lemon zest',
...
OMNIVORE = {
            ...
            'onion', 'crushed red pepper flakes', 'chiles de ￡rbol', 'fresh mint', 'zucchini', 'red bell pepper',
